...
// Assets (removed imports, using public paths)
      ...
      <div id="home" className="min-h-screen relative overflow-hidden">
          ...
          <div className="max-w-7xl z-10 mx-auto w-full">
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <span className="text-blue-200 font-bold tracking-widest uppercase text-sm font-raleway">
                  Portfolio
                </span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
                ...
                <div className="flex gap-4">
                  <SocialLink
                    href="mailto:phuocab191@gmail.com"
                    icon={<Mail size={20} />}
                  />
                  <SocialLink
                    href="https://www.facebook.com/UGFuZG9yYQ/"
                    icon={<Facebook size={20} />}
                  />
                  <SocialLink
                    href="https://www.linkedin.com/in/phuoc-hoang-bao-9b4b63368/"
                    icon={<Linkedin size={20} />}
                  />
                  <SocialLink
                    href="https://github.com/HoangBaoPhuoc"
                    icon={<Github size={20} />}
                  />
                </div>
              </div>
        ...
        <section className="relative px-6 md:px-20 pb-20 space-y-32">
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center">
            ...
            >
              <p>
                I am a third-year Information Security student at the University
                of Information Technology (VNU-HCM) with a strong interest in
                DevOps and Cloud Engineering. I am passionate about building
                practical systems that are reliable, scalable, and secure, and
                that deliver real value to users.
              </p>
              <p>
                I enjoy working on hands-on projects involving Linux, Docker,
                Kubernetes, Terraform, and cloud platforms such as AWS and GCP.
                Through personal labs, academic projects, and self-initiated
                workshops, I continuously strengthen my understanding of
                infrastructure automation, CI/CD pipelines, and multi-cloud
                environments, while applying a security-first mindset in system
                design.
              </p>
              <p>
                Although my academic background is in Information Security, I am
                actively expanding my career path toward DevOps and Cloud
                Engineering, where I can combine security principles with modern
                engineering practices. My goal is to gain real-world experience
                in a professional environment, contribute meaningful value to
                products and users, and grow into a reliable and well-rounded
            ...
            >
              ...
              <img
                ...
                alt="Portrait 1"
                className="relative rounded-2xl shadow-2xl w-full object-cover transform group-hover:scale-[1.02] transition-transform duration-500 border border-white/10"
              />
            </motion.div>
          </div>
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center">
            ...
            >
              <p>
                Beyond academics, I have been actively involved in student and
                community activities since high school. I began as a Youth Union
                collaborator at the high school level, where I developed a
                strong interest in event organization and teamwork.
              </p>
              <p>
                At university, I continued contributing as a Faculty Youth Union
                collaborator, later advancing to a member of the Executive
                Committee, where I currently serve as Head of the Design Team.
                In this role, I leverage AI-assisted workflows and am proficient
                in Adobe Photoshop to support event branding and communications.
              </p>
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center">
            ...
            >
              <p>
                I was born and raised in Da Nang, a coastal city that shaped my
                adaptability and open mindset.
              </p>
              <p>
                Outside of work and study, I enjoy traveling and film
                photography, which help me cultivate patience, attention to
                detail, and a creative perspective—qualities that I also bring
                into my technical and collaborative work.
              </p>
