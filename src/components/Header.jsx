          ...
          {isAuthenticated ? (
            <>
              <button
                ...
                className="ml-6 p-2 rounded-full hover:bg-green-500/20 transition-all duration-500 text-green-400 hover:text-green-300 flex items-center gap-2"
              ...
              <button
                ...
                className="p-2 rounded-full hover:bg-red-500/20 transition-all duration-500 text-red-400 hover:text-red-300 flex items-center gap-2"
                title="Logout"
              >
                <LogOut size={20} />
              </button>
            ...
            {isAuthenticated ? (
              <>
                <button
                  ...
                  className="px-4 py-2 text-green-400 flex items-center gap-2 cursor-pointer hover:text-green-300 hover:bg-green-500/10 rounded-lg transition-all"
                >
                  <Shield size={16} /> Restricted Area
                </button>
                <button
                  onClick={handleLogout}
                  className="px-4 py-2 text-red-400 flex items-center gap-2 cursor-pointer hover:text-red-300 hover:bg-red-500/10 rounded-lg transition-all"
                >
